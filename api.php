...
//-- Methods --//
///////////////////////////////////////////////////
$array = array("BETAv2", "BETA",  "HTTP-UAM", "HTTP-ABUSE", "HTTP-PROXY", "HTTP-SPAM", "stop", "STOP");// Add you're existing methods here, and delete you're none existent methods.
$ray = array("ASTRO");
...
if ($method == "HTTP-UAM") { $command = "screen -dm node /root/uambypass.js $host $time 250 proxies.txt 1"; }
